...
If(-not $uninstall) {
    ...
    Invoke-RestMethod -Method Get -Uri "https://dl.google.com/chrome/install/googlechromestandaloneenterprise64.msi" -OutFile "$PSScriptRoot/Files/$($hashtable.InstallerFile)"
}
