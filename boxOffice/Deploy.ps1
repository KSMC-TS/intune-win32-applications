...
If(-not $uninstall) {
    ...
    Invoke-RestMethod -Method Get -Uri "https://e3.boxcdn.net/box-installers/boxforoffice/currentrelease/BoxForOffice.msi" -OutFile "$PSScriptRoot/Files/$($hashtable.InstallerFile)"
}
