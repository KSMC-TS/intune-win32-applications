...
If(-not $uninstall) {
    ...
    Invoke-RestMethod -Method Get -Uri "https://download.mozilla.org/?product=firefox-latest-ssl&os=win64&lang=en-US" -OutFile "$PSScriptRoot/Files/$($hashtable.InstallerFile)"
}
