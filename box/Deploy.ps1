...
If(-not $uninstall) { 
    ...
    Invoke-RestMethod -Method Get -Uri "https://e3.boxcdn.net/box-installers/desktop/releases/win/Box-x64.msi" -OutFile "$PSScriptRoot/Files/$($hashtable.InstallerFile)"
}
